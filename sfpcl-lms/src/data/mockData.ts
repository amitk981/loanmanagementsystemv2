...
export const documents: DocumentRecord[] = [
  ...
  { id: 'd015', applicationId: 'app004', documentType: 'tri_party', requiredFlag: 'conditional', status: 'uploaded', version: 1, stampStatus: 'not_required', notarisationStatus: 'not_required' },
  { id: 'd016', applicationId: 'app004', documentType: 'sh4', requiredFlag: 'conditional', status: 'signed', version: 1, stampStatus: 'not_required', notarisationStatus: 'not_required' },
  ...
  { id: 'd018', applicationId: 'app004', documentType: 'term_sheet', requiredFlag: 'mandatory', status: 'uploaded', version: 1, stampStatus: 'not_required', notarisationStatus: 'not_required' },
  { id: 'd019', applicationId: 'app004', documentType: 'cancelled_cheque', requiredFlag: 'mandatory', status: 'verified', version: 1, stampStatus: 'not_required', notarisationStatus: 'not_required' },
  { id: 'd020', applicationId: 'app004', documentType: 'blank_cheque', requiredFlag: 'mandatory', status: 'complete', version: 1, stampStatus: 'not_required', notarisationStatus: 'not_required' },
